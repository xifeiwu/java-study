...
public class UDPMulticastServer {
    ...
    public class StartServer implements Runnable {
        ...
        StartServer() {
            logger = Logger.getLogger(UDPMulticastServer.class.getName());
